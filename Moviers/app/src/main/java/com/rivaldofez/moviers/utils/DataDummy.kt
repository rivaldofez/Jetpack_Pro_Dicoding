...
object DataDummy {
    fun generateDummyMovies(): List<MovieEntity> {
        ...
        movies.add(MovieEntity(
            ...
            backdropPath = "https://image.tmdb.org/t/p/w500/8f9dnOtpArDrOMEylpSN9Sc6fuz.jpg",
        ...
        movies.add(MovieEntity(
            ...
            trailerUrl = "https://www.youtube.com/watch?v=hg3pFV0yIhA"
        ))
        movies.add(MovieEntity(
            id = "700",
            title = "Octopussy",
            ...
            trailerUrl = "https://www.youtube.com/watch?v=q1hLWZzgZvU"
        ))
        movies.add(MovieEntity(
            id = "701",
            ...
            trailerUrl = "https://www.youtube.com/watch?v=ciIanh31mY4"
        ))
        movies.add(MovieEntity(
            id = "600",
        ...
        movies.add(MovieEntity(
            ...
            trailerUrl = "https://www.youtube.com/watch?v=NL6mioAlpJk"
        ))
        movies.add(MovieEntity(
            id = "567",
            title = "Rear Window",
    ...
    fun generateDummyTvShow() : List<TvShowEntity> {
        ...
        tvShows.add(TvShowEntity(
            ...
            trailerUrl = "https://www.youtube.com/watch?v=Yj0l7iGKh8g"
        ))
        tvShows.add(TvShowEntity(
            id = "2",
            title = "Lucifer",
        ...
        tvShows.add(TvShowEntity(
            ...
            trailerUrl = "https://www.youtube.com/watch?v=XQS7JkQmlx8"
        ))
        tvShows.add(TvShowEntity(
            id = "5",
            title = "The Gifted",
            ...
            trailerUrl = "https://www.youtube.com/watch?v=3pDdXYf3nfc"
        ))
        tvShows.add(TvShowEntity(
            id = "6",
            title = "Loki",
        ...
        tvShows.add(TvShowEntity(
            ...
            trailerUrl = "https://www.youtube.com/watch?v=V13W9gQ_1GA"
        ))
        tvShows.add(TvShowEntity(
            id = "9",
        ...
        tvShows.add(TvShowEntity(
            ...
            trailerUrl = "https://www.youtube.com/watch?v=GXrDYboUnnw"
        ))
